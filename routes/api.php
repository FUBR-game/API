...
Route::middleware('auth:api')->namespace('API')->group(static function () {
    ...
    Route::post('users/friends/add', ['as' => 'api.users.friends.add', 'uses' => 'UserController@addFriend']);
    Route::get('users/friends', ['as' => 'api.users.friends', 'uses' => 'UserController@friends']);
